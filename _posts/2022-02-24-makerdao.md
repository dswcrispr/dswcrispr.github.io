...
---
 ...
 이번 포스트에서는 암호자산 담보 Stablecoin의 대표적인 예시인 Dai의 시스템인 Maker 프로토콜에 대해서 설명한다. Maker 프로토콜 홈페이지에 게시된 [white paper](https://makerdao.com/en/whitepaper/)를 요약 및 정리하여 프로토콜의 작동원리, Dai stablecoin의 개념, 가격 유지 매커니즘 등에 대해 알아볼 것이다.   
