...
<br>  
현재 시장에서 가장 많이 사용되는 UST(US TeTher), USDC(USD coin) 등은 법정화폐담보(발행 주체가 보유한 달러화만큼의 stablecoin을 발행) 방식이다. 그러나 이러한 법정화폐담보 방식은 중앙화된 발행 주체가 임의로 stablecoin의 발행량을 조절할 수 있다는 문제가 있고 실제로 UST의 경우 이러한 문제로 미국 금융당국의 제재를 받기도 하였다.  
<br>
